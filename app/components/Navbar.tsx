  ...
  return (
    <header className={`flex bg-purple-500 w-full h-20 items-center dark:bg-zinc-900`}>
      <div className='flex w-[95%] md:w-[80%] mx-auto h-full items-center justify-between text-white'>
        ...
        <div className='flex w-full justify-end mr-16 items-center h-full gap-4'>
          <Link href='/sobre' className='flex h-full items-center  hover:border-purple-900 hover:border-b-4 hover:mt-1'>
            Sobre
          </Link>
